...
PRE_LAB_SOURCES = (
    "workshop/checkpoints/0-starter/checkout.py",
    "workshop/checkpoints/0-starter/validation.py",
...
def load_generator():
    ...
    spec = importlib.util.spec_from_file_location("traffic_generate", ROOT / "workshop/traffic/generate.py")
...
class PreLabLogTests(unittest.TestCase):
    ...
    def test_rejection_wording_is_inconsistent_and_unindexed(self):
        source = (ROOT / "workshop/checkpoints/0-starter/validation.py").read_text()
        namespace: dict = {}
    ...
    def test_completed_lab_promotes_the_event_to_warning(self):
        source = (ROOT / "workshop/checkpoints/3-logs-complete/validation.py").read_text()
